  ...
  return (
    <div className={`min-h-screen bg-gray-50 ${isZh ? 'font-chinese' : 'font-comic'}`}>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="rounded-xl shadow-lg overflow-hidden backdrop-blur-sm px-8 py-20">
            {/* 个人信息头部 */}
            ...
            <div className="pt-24 px-8 pb-8" ref={contentRef} style={zhFontStyle}>
              ...
              <p className="text-gray-600 mb-6" style={zhFontStyle}>{t('title', { ns: 'about' })}</p>
                ...
                <a 
                  ...
                  onClick={(e) => {
                  e.preventDefault();
                  // You could show a QR code modal here instead
                  alert(t('about.scanWeChatQRCode'));
                  }}
                  className="text-gray-600 hover:text-gray-900 relative group"
                  title={t('about.officialAccount')}
                >
              ...
              <div className="prose prose-lg max-w-none" style={zhFontStyle}>
                ...
                <div className="flex flex-wrap gap-2 mt-2" style={zhFontStyle}>
                  <span className="bg-blue-100 text-blue-800 border-2 border-blue-300 text-sm font-medium px-3 py-1 rounded-full" style={zhFontStyle}>
                    {t('interest1', { ns: 'about' })}
                  </span>
                  <span className="bg-green-100 text-green-800 border-2 border-green-300 text-sm font-medium px-3 py-1 rounded-full" style={zhFontStyle}>
                    {t('interest2', { ns: 'about' })}
                  </span>
                  <span className="bg-purple-100 text-purple-800 border-2 border-purple-300 text-sm font-medium px-3 py-1 rounded-full" style={zhFontStyle}>
                    {t('interest3', { ns: 'about' })}
                  </span>
                  <span className="bg-amber-100 text-amber-800 border-2 border-amber-300 text-sm font-medium px-3 py-1 rounded-full" style={zhFontStyle}>
